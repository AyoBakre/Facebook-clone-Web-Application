...
class User(UserMixin, db.Model):
    ...
    school = db.Column(db.String(140), default="--add data--")
    hometown = db.Column(db.String(140), default="--add data--")
    location = db.Column(db.String(140), default="--add data--")
    relationship = db.Column(db.String(140), default="--add data--")
